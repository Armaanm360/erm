...
const admin_users_validator_1 = __importDefault(require("./../utils/validator/admin.users.validator"));
class AdminAuthController extends abstract_controller_1.default {
    constructor() {
        ...
        // login
        this.login = this.asyncWrapper.wrap({ bodySchema: this.adminUserValidator.adminLoginValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        // update profile
        this.updateProfile = this.asyncWrapper.wrap({ bodySchema: this.adminUserValidator.adminProfileUpdateValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        // forget password
        this.forgetPassword = this.asyncWrapper.wrap({ bodySchema: this.adminUserValidator.adminForgetPasswordValidator }, (req, res) => __awaiter(this, void 0, void 0, function* () {
