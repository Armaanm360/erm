...
class AdminDiscussionController extends abstract_controller_1.default {
    constructor() {
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _e = yield this.DiscussionService.getSinglePolls(req), { code } = _e, data = __rest(_e, ["code"]);
            res.status(code).json(data);
        }));
        //update Discussion
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _f = yield this.DiscussionService.updateDiscussion(req), { code } = _f, data = __rest(_f, ["code"]);
            res.status(code).json(data);
        }));
        //delete Discussion
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _g = yield this.DiscussionService.deleteDiscussion(req), { code } = _g, data = __rest(_g, ["code"]);
            res.status(code).json(data);
        }));
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _h = yield this.DiscussionService.getSingleDiscussion(req), { code } = _h, data = __rest(_h, ["code"]);
            res.status(code).json(data);
        }));
        //create comment
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _j = yield this.DiscussionService.createComment(req), { code } = _j, data = __rest(_j, ["code"]);
            res.status(code).json(data);
        }));
        //delete comment
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _k = yield this.DiscussionService.deleteComment(req), { code } = _k, data = __rest(_k, ["code"]);
            res.status(code).json(data);
        }));
    }
}
