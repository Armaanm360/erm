...
class AdminRequisitionController extends abstract_controller_1.default {
    constructor() {
        ...
        {}, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _c = yield this.AdminRequisitionService.createNewStock(req), { code } = _c, data = __rest(_c, ["code"]);
            res.status(code).json(data);
        }));
        //create items
        ...
        {}, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _d = yield this.AdminRequisitionService.updateRequisition(req), { code } = _d, data = __rest(_d, ["code"]);
            res.status(code).json(data);
        }));
        ...
        // { bodySchema: this.RequisitionValidator.createRequisition },
        {}, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _e = yield this.AdminRequisitionService.getSingleRequisitionTrack(req), { code } = _e, data = __rest(_e, ["code"]);
            res.status(code).json(data);
        }));
        //get all discussion
        ...
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _f = yield this.AdminRequisitionService.getAllDiscussion(req), { code } = _f, data = __rest(_f, ["code"]);
            res.status(code).json(data);
        }));
        //get all items
        this.getAllItems = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.queryListLimitSkip }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _g = yield this.AdminRequisitionService.getAllItems(req), { code } = _g, data = __rest(_g, ["code"]);
            res.status(code).json(data);
        }));
        ...
        this.getAllTransactions = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.queryListLimitSkip }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _h = yield this.AdminRequisitionService.getAllTransactions(req), { code } = _h, data = __rest(_h, ["code"]);
            res.status(code).json(data);
        }));
        ...
        this.getAllRequisitions = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.queryListLimitSkip }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _j = yield this.AdminRequisitionService.getAllRequisitions(req), { code } = _j, data = __rest(_j, ["code"]);
            res.status(code).json(data);
        }));
        //get current stock
        this.getCurrentStock = this.asyncWrapper.wrap({ bodySchema: this.commonValidator.queryListLimitSkip }, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _k = yield this.AdminRequisitionService.getCurrentStock(req), { code } = _k, data = __rest(_k, ["code"]);
            res.status(code).json(data);
        }));
        //update Discussion
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _l = yield this.AdminRequisitionService.updateDiscussion(req), { code } = _l, data = __rest(_l, ["code"]);
            res.status(code).json(data);
        }));
        //delete Discussion
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _m = yield this.AdminRequisitionService.deleteDiscussion(req), { code } = _m, data = __rest(_m, ["code"]);
            res.status(code).json(data);
        }));
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _o = yield this.AdminRequisitionService.getSingleDiscussion(req), { code } = _o, data = __rest(_o, ["code"]);
            res.status(code).json(data);
        }));
        //create comment
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _p = yield this.AdminRequisitionService.createComment(req), { code } = _p, data = __rest(_p, ["code"]);
            res.status(code).json(data);
        }));
        //delete comment
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _q = yield this.AdminRequisitionService.deleteComment(req), { code } = _q, data = __rest(_q, ["code"]);
            res.status(code).json(data);
        }));
    }
}
