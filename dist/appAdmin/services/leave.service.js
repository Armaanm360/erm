    ...
    updateLeave(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                // const start_date = req.body.start_date;
                // const end_date = req.body.start_date;
                // const check = await model.checkDuplicateLeaveDuringUpdate(
                //   id,
                ...
                // );
                //check date exsists
                const update = yield model.updateLeaveApplication(id, req.body);
                //==============================================
                //                Notification Section
                //==============================================
                const employee = yield model.getSingleLeave(id);
                ...
                const get_user_socket_id = yield this.Model.employeeModel().getSingleInfoEmployee(employee[0].employee_id);
