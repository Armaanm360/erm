        ...
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const notify = yield this.Model.commonModel().createNotification({
                    type: "meeting",
                    ref_id: meeting_id,
                    message: `আপনাকে একটি মিটিং এ যুক্ত করা হয়েছে  ${meetingInfo[0].meeting_title}`,
                });
                ...
                const userid = req.body.person_id;
                const get_user_socket_id = yield this.Model.employeeModel().getSingleInfoEmployee(userid);
                ...
                const { meeting_title, meeting_description } = meetingInfo[0];
                // const accessToken =
                //   await PushNotificationService.generateFCMAccessToken();
                // await PushNotificationService.sendNotificationToSelectedDriver(
                //   accessToken,
                //   meeting_title,
                //   meeting_description,
                //   personinfo[0].device_token
                // );
...
`,
                ...
                //  io.emit('notification', `You Have Been Added To Meeting ${meeting_id}`);
                const get_user_socket_id = yield this.Model.employeeModel().getSingleInfoEmployee(person_id);
                console.log("User info:", get_user_socket_id);
                if (!get_user_socket_id || !get_user_socket_id.socket_id) {
                    console.error("Socket ID not found for user:", person_id);
                }
                else {
                    console.log("Socket ID:", get_user_socket_id.socket_id);
                }
    ...
    updateMeetingTest() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                    yield this.Model.adminActivityModel().updateMeetingStatusTest();
                    // await this.Model.crmLeadModel().insertInLeadTracking({
                    //   action_type: 'Node Cron Scheduling',
                    //   description: `Armaan`,
                    //   lead_id: 231,
                    //   admin_id: 27,
                ...
                console.error("Error in updateMeetingTest:", error);
                throw error; // Optionally rethrow if you want to handle it at a higher level
            }
        });
    }
}
