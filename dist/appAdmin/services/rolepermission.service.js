    ...
    updateRolePermission(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const getRolePermissionGroupIDS = yield this.Model.RolePermissionModel().getPermissionGroupIdWise(updated_role_id);
                const groupIDSarray = getRolePermissionGroupIDS.map((id) => id.role_permission_group_id);
                const deleteGroupIdRoleWise = yield this.Model.RolePermissionModel().deleteRoleWithPermissionGroupId(groupIDSarray);
                const { role_name, authority } = req.body;
                //create a role
    ...
    getRolesWithPermission(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const roleId of uniqueRoleIds) {
                ...
                const group_permission = yield this.Model.RolePermissionModel().getPermissionGroupIdWise(roleId);
