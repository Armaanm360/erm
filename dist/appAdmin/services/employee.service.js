...
class AdminEmployeeService extends abstract_service_1.default {
    ...
    createEmployee(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const _a = req.body, { email, phone, name, shift_id, product_lead_permission, permission_auth } = _a, rest = __rest(_a, ["email", "phone", "name", "shift_id", "product_lead_permission", "permission_auth"]);
                ...
                // send sms
                yield lib_1.default.sendEmail(email, constants_1.OTP_FOR_CREDENTIALS, (0, employeeCredentials_template_1.newEmployeeAccount)(email, autoPass));
                return {
                    success: true,
    ...
    getAllEployee(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { key, limit, skip, type } = req.query;
            const { organization_id } = req.admin;
