...
class EmployeeDiscussionController extends abstract_controller_1.default {
    constructor() {
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _c = yield this.DiscussionService.getSinglePolls(req), { code } = _c, data = __rest(_c, ["code"]);
            res.status(code).json(data);
        }));
        //get all discussion
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _d = yield this.DiscussionService.getAllDiscussion(req), { code } = _d, data = __rest(_d, ["code"]);
            res.status(code).json(data);
        }));
        this.getAllPolls = this.asyncWrapper.wrap(
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _e = yield this.DiscussionService.getAllPolls(req), { code } = _e, data = __rest(_e, ["code"]);
            res.status(code).json(data);
        }));
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _f = yield this.DiscussionService.getSingleDiscussion(req), { code } = _f, data = __rest(_f, ["code"]);
            res.status(code).json(data);
        }));
        //create comment
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _g = yield this.DiscussionService.createComment(req), { code } = _g, data = __rest(_g, ["code"]);
            res.status(code).json(data);
        }));
        //delete comment
        ...
        // { bodySchema: this.DiscussionValidator.createDiscussion },
        null, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _h = yield this.DiscussionService.deleteComment(req), { code } = _h, data = __rest(_h, ["code"]);
            res.status(code).json(data);
        }));
    }
}
