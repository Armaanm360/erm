...
const employee_users_validator_1 = __importDefault(require("../../auth/utils/validator/employee.users.validator"));
class MemberEmployeeController extends abstract_controller_1.default {
    constructor() {
        super();
        this.employeeService = new employee_service_1.default();
        this.employeeServiceValidator = new employee_users_validator_1.default();
        //Get all Employee
