...
class EmployeeModel extends schema_1.default {
    ...
    getAllEmploye(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const { email, key, limit, skip, organization_id, type } = payload || {};
    ...
    getSingleEmployee(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db("crm_employee_view as emp")
                ...
                .leftJoin("organization as o", "o.id", "=", "emp.organization_id")
                .where(function () {
                if (id) {
    ...
    updateSocket(payload, id) {
        return __awaiter(this, void 0, void 0, function* () {
            const shift = yield this.db("user_admin")
                .withSchema(this.CRM_SCHEMA)
                .where({ id })
                .update(payload);
            return shift;
